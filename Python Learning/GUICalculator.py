...
btnC = Button(root,padx=30,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='c', bg='green', command=Clear).grid(row=1,column=3)
...
btnplus = Button(root,padx=33,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='+', bg='orange', command=lambda:btn('+')).grid(row=2,column=3)
...
btnminus = Button(root,padx=38,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='-', bg='orange', command=lambda:btn('-')).grid(row=3,column=3)

#=================================Row 4================================
btn0 = Button(root,padx=30,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='0', command=lambda:btn(0)).grid(row=4,column=0)
btndot = Button(root,padx=35,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='.', command=lambda:btn('.')).grid(row=4,column=1)
btndivision = Button(root,padx=36,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='/', command=lambda:btn('/')).grid(row=4,column=2)
btnmultiply = Button(root,padx=34,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='x', bg='orange', command=lambda:btn('*')).grid(row=4,column=3)

#=================================Row 5================================
btnequals = Button(root,padx=95,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='=', bg='green', command=Equal).grid(row=5,column=0)
btnopenbracket = Button(root,padx=35,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='(', bg='orange', command=lambda:btn('(')).grid(row=5,column=1)
btnclosebracket = Button(root,padx=38,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text=')', bg='orange', command=lambda:btn(')')).grid(row=5,column=2)
#btnmultiply = Button(root,padx=30,pady=15,bd=8,fg='black',font={'arial',30,'bold'},text='x', bg='orange').grid(row=4,column=3)
